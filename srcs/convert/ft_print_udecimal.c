...
/*   Updated: 2020/12/14 22:47:37 by alafranc         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int ft_display_nb_udecimal(long nb, int size_nb, t_flags flags)
{
	int count;
...
int	ft_print_udecimal(va_list ap, t_flags flags)
{
	...
	count += ft_display_nb_udecimal(nb, size_nb, flags);
